...
public class AppConstants {
    ...
    // action
    public static final String ACTION_FINISH_ACTIVITY = "com.moko.sensor.action.finishActivity";
    public static final String ACTION_MODIFY_NAME = "com.moko.sensor.action.ACTION_MODIFY_NAME";
    public static final String ACTION_DEVICE_STATE = "com.moko.sensor.action.ACTION_DEVICE_STATE";
    // sp
    public static final String SP_NAME = "sp_name_sensor";
    ...
    public static final int REQUEST_CODE_SELECT_WORK_MODE = 123;
